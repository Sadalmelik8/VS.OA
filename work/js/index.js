                ...
                $.each(dataObj.ret, function (index, item) {
                    if (dataObj.ret[0].id == 0) {
                        ...
                        con += "<div class='icon' id=" + item.num + ">"
                            + "<span>" + item.f_timestamp.substr(0, 4) + '/' + item.f_timestamp.substr(4, 2) + '/' + item.f_timestamp.substr(6, 2) + '&nbsp;' + item.f_timestamp.substr(8, 2) + ':' + item.f_timestamp.substr(10, 2) + ':' + item.f_timestamp.substr(12, 2) + "</span>"
